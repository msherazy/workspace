...
const initialTasks = [
  {
    ...
    priority: "high",
    project: "Client A",
    description: "Create low-fidelity wireframes for onboarding flow",
  },
  {
    id: "2",
    title: "Fix API bug",
    ...
    priority: "medium",
    project: "Client B",
    description: "Resolve 500 error on user login endpoint",
  },
  {
    id: "3",
    ...
    priority: "low",
    project: "Client A",
    description: "Push final version to production",
  },
  {
    id: "4",
    ...
    priority: "high",
    project: "Client B",
    description: "Evaluate third-party dependencies for vulnerabilities",
  },
  {
    id: "5",
  ...
  },
  {
    ...
    priority: "low",
    project: "Client C",
    description: "Convert to Tailwind utility classes",
  },
  {
    id: "9",
  ...
  },
  {
    ...
    priority: "high",
    project: "Client B",
    description: "Optimize page load time and Core Web Vitals",
  },
  {
    id: "11",
    title: "Setup CI/CD",
  ...
  },
  {
    ...
    priority: "medium",
    project: "Client A",
    description: "Fix layout issues on small devices",
  },
];
...
export default function Dashboard() {
  ...
  const onDragOver = (event) => {
    ...
    const newStatus =
      overTask?.status || (statuses.includes(overId) ? overId : null);
    if (newStatus) {
  ...
  return (
    <div
      className={`${darkMode ? "dark bg-zinc-900 text-white" : "bg-zinc-100 text-black"} min-h-screen transition-colors flex ${inter.className}`}
    >
      <aside
        className={`w-full md:w-64 p-6 border-r ${darkMode ? "bg-zinc-800 border-zinc-700" : "bg-zinc-50 border-gray-200"}`}
      >
        <h2
            ...
            {statuses.map((status) => {
              ...
              return (
                <TaskColumnDroppable
                  key={status}
                  status={status}
                  isTargetColumn={targetColumn === status}
                  darkMode={darkMode}
                >
                  <h2 className="font-semibold text-lg mb-3 flex justify-between items-center">
                    {statusLabels[status]}{" "}
                    <span className="text-sm font-medium text-zinc-800 dark:text-zinc-300 ml-2">
