...
const faqs = [
  {
    ...
    answer:
      "Yes, every plan comes with a 14-day free trial. No credit card needed.",
  },
  {
...
export default function PricingPage() {
  ...
  return (
    <div
      className={
        theme === "light"
          ? "min-h-screen bg-gradient-to-b from-gray-50 to-white text-black"
          : "min-h-screen bg-gradient-to-tr from-gray-900 via-blue-900 to-gray-800 text-white"
      }
    >
      {/* Tooltip */}
      {showTooltip && (
      ...
      <header
        className={`sticky top-0 z-50 backdrop-blur-md ${
          theme === "light"
            ? "bg-white/80 border-b border-gray-300"
            : "bg-gray-900/70 border-b border-gray-700"
              ...
              <motion.div
                ...
                className={`relative rounded-3xl p-8 shadow-xl transition backdrop-blur-md ${
                  theme === "light"
                    ...
                    : "bg-white/10 border border-blue-700"
