...
const soaps: Soap[] = [
  {
    ...
    description:
      "Relax with our lavender soap, made with real lavender petals and essential oils.",
  },
  {
    name: "Citrus Burst",
    price: "$7.99",
    image:
      "https://images.unsplash.com/photo-1604176354204-9268737828e4?q=80&w=1000",
    description:
      "Invigorate your senses with our citrus blend, combining orange, lemon, and grapefruit essential oils.",
  },
  {
    name: "Minty Fresh",
    price: "$8.99",
    image:
      "https://images.unsplash.com/photo-1625772452859-1c03d5bf1137?q=80&w=1000",
    description:
      "Cool down with our refreshing mint soap, perfect for morning routines.",
  },
];
        ...
        <div className="p-6">
          ...
          <div className="bg-gray-100 dark:bg-gray-700 p-4 rounded-lg">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300">
              Natural oils, essential oils, organic herbs, plant extracts, and
              other natural ingredients. No synthetic fragrances or harsh
              chemicals.
            </p>
          </div>
        </div>
    ...
    >
      ...
      <div className="p-6 flex flex-col flex-1">
        <div className="flex justify-between items-start mb-3">
          <h3
            className={`${isDarkMode ? "text-white" : "text-gray-900"} text-xl font-bold `}
            style={{ fontFamily: "'Playfair Display', serif" }}
          >
            {soap.name}
          </h3>
        ...
        <p
          className={`${isDarkMode ? "text-white" : "text-gray-700"} text-sm mb-auto`}
          style={{ fontFamily: "'Poppins', sans-serif" }}
        >
          {soap.description}
        </p>
...
export default function Home() {
  ...
  const handleSubscribe = (e: FormEvent) => {
    ...
    setTimeout(() => {
      setSubscribeStatus({
        message:
          "Thanks for subscribing! Please check your email for our newsletter.",
        isError: false,
      });
      setEmail("");
  ...
  return (
    <div
      className={`${isDarkMode ? "dark bg-gray-950" : "bg-gray-50"} min-h-screen transition-colors duration-500`}
      style={{ fontFamily: "'Poppins', sans-serif" }}
    >
      <main className="max-w-6xl mx-auto px-4 py-8 sm:py-12">
        <div className="flex justify-between items-center mb-12">
          <div>
            ...
            <p
              className={`${isDarkMode ? "text-gray-300" : "text-gray-700"} mt-3 text-lg max-w-lg`}
            >
              Handcrafted with{" "}
              <span className="text-indigo-600 dark:text-indigo-400 font-medium">
                natural ingredients
              </span>{" "}
              for a luxurious cleansing experience
            </p>
          </div>
          <button
            onClick={toggleTheme}
        ...
        <div className="relative overflow-hidden rounded-2xl p-8 text-white bg-gradient-to-r from-indigo-500 to-purple-600 dark:from-indigo-600 dark:to-purple-700 shadow-xl">
          <div className="relative z-10 max-w-2xl mx-auto text-center">
            ...
            <p className="text-indigo-100 dark:text-indigo-200 mb-6 text-lg">
              Get exclusive access to new arrivals, promotions, and skincare
              tips
            </p>
            <form
